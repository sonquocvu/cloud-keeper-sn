...
4. A real transfer requires a completed preview and explicit confirmation.
...
Checkpoint 1 enforces these rules through capability separation, the state machine, deterministic naming, migration constraints, redaction, and tests. The later transfer pipeline must preserve them.
